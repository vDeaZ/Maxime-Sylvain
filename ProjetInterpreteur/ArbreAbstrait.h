...
public:
    NoeudInstPour(Noeud* condition, Noeud* sequence, vector<Noeud*> affectations);
    virtual ~NoeudInstPour() {}
    int executer(); 
private:
    Noeud* m_cond;
    Noeud* m_seq;
    vector<Noeud*> m_affects;
};
////////////////////////////////////////////////////////////////////////////////
class NoeudInstSiRiche : public Noeud{
public:
    NoeudInstSiRiche(vector<Noeud*> sequences, vector<Noeud*> conditions, bool boolSinon);
    virtual ~NoeudInstSiRiche(){}
    int executer(); 
private:
    vector<Noeud*> m_seqs;
    vector<Noeud*> m_conds;
    bool m_boolSinon;
};
